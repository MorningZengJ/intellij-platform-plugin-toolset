...
public class AnimatedGifEncoder {
    ...
    protected void getImagePixels() {
        ...
        if ((w != width) || (h != height) || (type != BufferedImage.TYPE_3BYTE_BGR)) {
            ...
            BufferedImage temp = ImageUtil.createImage(width, height, BufferedImage.TYPE_3BYTE_BGR);
    ...
    protected void writeGraphicCtrlExt() throws IOException {
        ...
        // packed fields
        // 1:3 reserved // 4:6 disposal // 7   user input - 0 = none
    ...
    protected void writeLSD() throws IOException {
        ...
        writeShort(height);
        // packed fields
        // 1   : global color table flag = 1 (gct used)	// 2-4 : color resolution = 7	 // 5   : gct sort flag = 0
